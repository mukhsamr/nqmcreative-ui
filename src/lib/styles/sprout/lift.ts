...
export const softOnHover =
	'hover:shadow-[0_6px_0_0_rgba(20,83,45,0.10),0_18px_36px_-12px_rgba(20,83,45,0.22)]';
 ...
 */
export const lift: Record<Tone, string> = {
	brand:
		'shadow-[0_5px_0_0_color-mix(in_oklab,var(--color-brand)_72%,black)] active:shadow-[0_2px_0_0_color-mix(in_oklab,var(--color-brand)_72%,black)]',
	accent:
		'shadow-[0_5px_0_0_color-mix(in_oklab,var(--color-accent)_72%,black)] active:shadow-[0_2px_0_0_color-mix(in_oklab,var(--color-accent)_72%,black)]',
	violet:
		'shadow-[0_5px_0_0_color-mix(in_oklab,var(--color-violet)_72%,black)] active:shadow-[0_2px_0_0_color-mix(in_oklab,var(--color-violet)_72%,black)]',
	...
	success:
		'shadow-[0_5px_0_0_color-mix(in_oklab,var(--color-success)_72%,black)] active:shadow-[0_2px_0_0_color-mix(in_oklab,var(--color-success)_72%,black)]',
	warning:
		'shadow-[0_5px_0_0_color-mix(in_oklab,var(--color-warning)_72%,black)] active:shadow-[0_2px_0_0_color-mix(in_oklab,var(--color-warning)_72%,black)]',
	danger:
		'shadow-[0_5px_0_0_color-mix(in_oklab,var(--color-danger)_72%,black)] active:shadow-[0_2px_0_0_color-mix(in_oklab,var(--color-danger)_72%,black)]',
	neutral:
		'shadow-[0_5px_0_0_color-mix(in_oklab,var(--color-neutral)_72%,black)] active:shadow-[0_2px_0_0_color-mix(in_oklab,var(--color-neutral)_72%,black)]'
};
 ...
 */
export const liftSoft: Record<Tone, string> = {
	brand:
		'shadow-[0_5px_0_0_var(--color-brand-border)] active:shadow-[0_2px_0_0_var(--color-brand-border)]',
	accent:
		'shadow-[0_5px_0_0_var(--color-accent-border)] active:shadow-[0_2px_0_0_var(--color-accent-border)]',
	violet:
		'shadow-[0_5px_0_0_var(--color-violet-border)] active:shadow-[0_2px_0_0_var(--color-violet-border)]',
	info: 'shadow-[0_5px_0_0_var(--color-info-border)] active:shadow-[0_2px_0_0_var(--color-info-border)]',
	success:
		'shadow-[0_5px_0_0_var(--color-success-border)] active:shadow-[0_2px_0_0_var(--color-success-border)]',
	warning:
		'shadow-[0_5px_0_0_var(--color-warning-border)] active:shadow-[0_2px_0_0_var(--color-warning-border)]',
	danger:
		'shadow-[0_5px_0_0_var(--color-danger-border)] active:shadow-[0_2px_0_0_var(--color-danger-border)]',
	neutral:
		'shadow-[0_5px_0_0_var(--color-neutral-border)] active:shadow-[0_2px_0_0_var(--color-neutral-border)]'
};

/** The same lip at 3px, for things too small to travel: icon tiles, dots. */
export const liftSm: Record<Tone, string> = {
