...
export type Tone =
	'brand' | 'accent' | 'violet' | 'info' | 'success' | 'warning' | 'danger' | 'neutral';
...
export const toneFocusBorder: Record<Tone, string> = {
...
export const toneFocusWithinRing: Record<Tone, string> = {
...
export const toneFocusWithinBorder: Record<Tone, string> = {
...
export const tonePeerChecked: Record<Tone, string> = {
...
export const tonePeerFocus: Record<Tone, string> = {
...
export const toneHoverBorder: Record<Tone, string> = {
